...
const ResizableHandle = ({
  ...
  >
    {withHandle && (
      <div className="z-10 flex h-6 w-8 items-center justify-center rounded-sm border border-neutral-200 bg-neutral-200 dark:border-neutral-800 dark:bg-neutral-800">
